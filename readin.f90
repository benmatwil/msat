...
uptoring = preamble + (sum(nperring(1:nring-1))*8)
...
do null=1,nnulls
	...
	do
		...
		do i=nring,1,-1 !trace back each ring to the start
			...
			call position(i,index,a,b,p) !get positions in file belonging to the current ring
